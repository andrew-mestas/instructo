...
return top}
instructo.prototype.getOccurences=function(name){var results=this.depth>=1?this.dive():this.results;return this.getCounts(results,this.array.map((x)=>{return x[name]}).filter(this.onlyUnique))};module.exports=instructo;